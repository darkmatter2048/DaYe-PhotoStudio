# Form implementation generated from reading ui file 'turnimg.ui'
#
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", f"{self.lanpack[78]}"))
        self.comboBox.setItemText(1, _translate("MainWindow", f"{self.lanpack[79]}"))
        self.comboBox.setItemText(2, _translate("MainWindow", f"{self.lanpack[80]}"))
        self.comboBox.setItemText(3, _translate("MainWindow", f"{self.lanpack[81]}"))
        self.comboBox.setItemText(4, _translate("MainWindow", f"{self.lanpack[82]}"))

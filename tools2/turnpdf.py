# Form implementation generated from reading ui file 'turnpdf.ui'
#
...
class TURNPdf(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(430, 325)
...
"border: 1px solid rgb(255, 255, 255);")
        ...
        spacerItem6 = QtWidgets.QSpacerItem(20, 17, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
...
"}")
    ...
    def turnpdf(self, input_file, outputfile, rot):
        ...
        if self.label.text() != "Path":
            ...
            if folder_path == "":
                ...
                for file in self.somefiles:
                    ...
                    output_path = f'{folder_path}/{self.get_filename(file)}.pdf'

                    moshi = self.comboBox.currentIndex()
                    if moshi == 0:
                        #左转90度
                        self.turnpdf(file,output_path,rot=-90)
                    elif moshi == 1:
                        #右转90
                        self.turnpdf(file,output_path,rot=90)
                    elif moshi == 2:
                        #180
                        self.turnpdf(file,output_path,rot=180)
                ...
                pyautogui.alert("已完成图像旋转\nThe Image rotation task has been completed")  # 提示音
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "左转90度"))
        self.comboBox.setItemText(1, _translate("MainWindow", "右转90度"))
        self.comboBox.setItemText(2, _translate("MainWindow", "旋转180度"))

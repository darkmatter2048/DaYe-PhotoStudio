    ...
    def start_working(self):
        if self.label.text() != "Path":
            ...
            if folder_path == "":
                ...
                # 创建一个新的GIF图像对象
                gif_path = f'{self.convert_slashes(folder_path)}\\output.gif'
                frames = []
                ...
                pyautogui.alert("已完成GIF合成\nThe Synthetic GIFs task has been completed")  # 提示音
                #os.startfile(folder_path)
                self.open_and_select_file(gif_path)

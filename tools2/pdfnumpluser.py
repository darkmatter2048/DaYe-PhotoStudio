...
"}")
    ...
    def add_page_numbers(self, input_pdf, output_pdf):
        ...
        for i in range(len(reader.pages)):
            ...
            page = reader.pages[i]
            can.drawString(100, 50, f"{i + 1}")  # 在页面底部添加页码文本
            can.showPage()
            can.save()
        ...
        if self.label.text() != "Path":
            ...
            if folder_path == "":
                ...
                for file in self.somefiles:
                    ...
                    self.add_page_numbers(file, output_path)
                ...
                pyautogui.alert("已完成PDF添加页码\nThe Adding page numbers to PDFs task has been completed")  # 提示音

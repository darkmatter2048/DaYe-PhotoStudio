        ...
        if self.label.text() != "Path":
            ...
            if folder_path == "":
                ...
                for file in self.somefiles:
                    ...
                    # 调用函数并转换 PDF 文件
                    self.pdf_to_word(file, f"{folder_path}/{self.get_filename(file)}.docx")
                ...
                pyautogui.alert("已完成PDF转Word\nThe PDF to Word task has been completed")  # 提示音

...
"}")
    ...
    def start_working(self):
        if self.label.text() != "Path":
            ...
            if folder_path == "":
                ...
                pyautogui.alert("已完成尺寸修改\nThe dimension modification task has been completed")  # 提示音
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", f"{self.lanpack[69]}"))
        self.label_3.setText(_translate("MainWindow", f"{self.lanpack[70]}"))
